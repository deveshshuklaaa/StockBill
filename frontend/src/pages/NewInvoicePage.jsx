...
// Variant identity: weight + MRP distinguish same-name products.
// MRP is identification only — the selling price stays an editable input.
...
export default function NewInvoicePage() {
  ...
  async function submit(event) {
    ...
    try {
      ...
      // One key per form submission attempt: a double-click or retry of the
      // same form can never create two invoices or deduct stock twice.
